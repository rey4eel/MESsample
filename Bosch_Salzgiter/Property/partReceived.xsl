...
<xsl:param name="SideJob"/>
<xsl:param name="DefaultTypeNo"/>
...
<xsl:template match="/">
	<xsl:element name="root"> <!-- root - start -->
		...
		<xsl:element name="body"> <!-- body - start -->
			<xsl:element name="arrays"> <!-- arrays - start -->
				<xsl:element name="array">
					<xsl:attribute name="name">tools</xsl:attribute>
					<xsl:attribute name="dataType">8</xsl:attribute>
					<xsl:element name="item">
						<xsl:attribute name="value"><xsl:value-of select="$ToolID.Current"/></xsl:attribute>
					</xsl:element>
				</xsl:element>
			</xsl:element> <!-- arrays - end -->	
