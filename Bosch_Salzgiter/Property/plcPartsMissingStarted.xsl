  ...
  <xsl:template match="/">
	<xsl:element name="root"> <!-- root - start -->
		<xsl:element name="header"> <!-- header - start -->
			...
			<xsl:attribute name="eventName">plcPartsMissingStarted</xsl:attribute>
		...
		<xsl:element name="event"> <!-- event - start -->
			<xsl:element name="plcPartsMissingStarted"> <!-- plcPartsMissingStarted - start -->
				<xsl:attribute name="missingParts"><xsl:text>1</xsl:text></xsl:attribute>
				<xsl:choose>
		                <xsl:when test="$Lane='0'"> <!-- Front -->
			...
			</xsl:element> <!-- plcPartsMissingStarted - end -->
