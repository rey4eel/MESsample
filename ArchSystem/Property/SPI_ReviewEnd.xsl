...
<xsl:template match="/">
    ...
    <xsl:text>{</xsl:text>
        ...
        <xsl:text>"Info":{</xsl:text>
            ...
            <xsl:value-of select="InspectResult/PCB/@DefectStartDateTime"/>
            <xsl:text>"</xsl:text>
            <xsl:value-of select="$delimiter"/>
            <!-- ReviewEnd -->
            <xsl:text>"ReviewEnd":"</xsl:text>
            <xsl:value-of select="InspectResult/PCB/@DefectEndDateTime"/>
            <xsl:text>"</xsl:text>
        <xsl:text>}</xsl:text>
        <xsl:value-of select="$delimiter"/>
                                ...
                                <xsl:text>"Defect":[</xsl:text>
                                    <xsl:for-each select="Component/Pad[@Result&lt;-100]">
                                        ...
                                        <xsl:text>{</xsl:text>
                                            ...
                                            <xsl:value-of select="@DefectResultCustomerName"/>
                                            <xsl:text>"</xsl:text>
                                        <xsl:text>}</xsl:text>
